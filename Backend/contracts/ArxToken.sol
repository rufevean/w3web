...
//-------------------------------------constructor-------------------------------------
    ...
    constructor(uint _totalTokens, address _propertyOwner, string memory _name, string memory _symbol) ERC20(_name, _symbol) ERC20Permit(_name) {
...
//-------------------------------------onlyOwner functions-------------------------------------
    ...
    function initialize(address _collection, uint256 _tokenId) external onlyOwner {
        ...
        collection.safeTransferFrom(msg.sender, address(this), _tokenId); //taking nft from the nft owner
...
//-------------------------------------payable functions-------------------------------------
    ...
    function payRent() external payable {
        require((msg.sender == approvedRentee)||(msg.sender == propertyOwner), "Not approved to use this!"); //verify rentee is approved
